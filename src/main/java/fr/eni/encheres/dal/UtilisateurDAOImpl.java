...
public class UtilisateurDAOImpl implements UtilisateurDAO {
    ...
    private final String FIND_BY_PSEUDO="SELECT PSEUDO, NOM, PRENOM, EMAIL, TELEPHONE, RUE, CODEPOSTAL, VILLE, MOTDEPASSE, CREDIT, ADMINISTRATEUR, COMPTEACTIF FROM UTILISATEURS WHERE PSEUDO=:PSEUDO";
